        ...
        <AnimatePresence mode="popLayout" initial={false}>
          {!isOpen ? (
            <motion.div
              ...
              className="flex w-xs sm:w-sm items-center justify-between gap-4 sm:gap-10 border border-oklch(0.923 0.003 48.717) border-[#ECECEC] bg-white p-3 dark:border-white/5 dark:bg-[#1C1C1E] overflow-hidden dark:border-oklch(1 0 0 / 10%)"
            >
            ...
            <motion.div
              ...
              className="flex w-xs sm:w-sm flex-col border border-oklch(0.923 0.003 48.717) border-[#ECECEC] bg-white py-3 dark:border-white/5 dark:bg-[#1C1C1E] overflow-hidden dark:border-oklch(1 0 0 / 10%)"
              style={{
                borderRadius: 24,
              }}
            >
